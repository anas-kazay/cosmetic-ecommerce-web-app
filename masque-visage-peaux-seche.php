...
<html lang="en">
<head>
    <title>AYNOU-SHOP/Masque Visage -peaux seche-</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread"  style="color: white">Masque Visage -peaux sèche-</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate">
                <a href="images/amande-visage.jpg" class="image-popup"><img src="images/amande-visage.jpg" class="img-fluid" alt="amande-visage"></a>
            </div>
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                <h3>Masque visage -peaux sèche-</h3>
               
                <p class="price"><span>75.00 dH</span></p>
                <p>Le masque visage est un must beauté dédié aux peaux très sèches et délicates. A base d'argile blanche, il apaise et hydrate la peau tout en douceur
                    grâce à l'association d'extrait de feuille d'arganier aux huiles végétales nourrissantes (huile de macademia , huile d'amande douce et huile d'argan).
                </p>
...
<section class="ftco-section">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    ...
                    <div class="text py-3 pb-4 px-3 text-center">
                        ...
                        <div class="d-flex">
                            <div class="pricing">
                                <p class="price"><span>not yet</span></p>
                            </div>
                        </div>
                        <div class="bottom-area d-flex px-3">
                            <div class="m-auto d-flex">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    <a href="huile-douche.php" class="img-prod" ><img class="img-fluid" src="images/amande-visage2.jpg" alt="Colorlib Template"  />
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3 text-center">
