...
<html lang="en">
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" <?php echo "src=\"images/products/$product_image\" "?> alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">SKU: BST-498</div>
                        <h1 class="display-5 fw-bolder"><?php echo $product_title ?></h1>
                        <div class="fs-5 mb-5">
                            <span><?php echo $product_price  ?> DH</span>
                        </div>
                        <p class="lead"><?php echo $product_desc?>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium at dolorem quidem modi. Nam sequi consequatur obcaecati excepturi alias magni, accusamus eius blanditiis delectus ipsam minima ea iste laborum vero?</p>
                        <div class="d-flex">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="images/products/<?php echo $product_image?>" alt="product" class="img-fluid">
