...
<html lang="en">
<head>
    <title>AYNOU-SHOP/Amande GelDouche</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread">Amande GelDouche</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate">
                <a href="images/amande-corps2.jpg" class="image-popup"><img src="images/amande-corps2.jpg" class="img-fluid" alt="amande-corps"></a>
            </div>
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                <h3>Amande GelDouche</h3>
                
                <p class="price"><span>40.00 DH</span></p>
                <p>Le GelDouche à base d'amande vous procure un plaisir intense à travers ses senteurs uniques.
